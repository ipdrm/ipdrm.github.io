...
#### Panel Topic and General Information can be found [here](https://www.capsl.udel.edu/IPDRM19/){:target="_blank"}.
...
| `10:48-12:00` | [Panel](https://www.capsl.udel.edu/IPDRM19/){:target="_blank"} | Title: End-to-End Co-Design - Emerging Parallel and Distributed Runtime Systems and Middleware for Extreme-Scale Systems |
